                ...
                order.order?.orderItems.map((item) => <Grid container item className='shadow-xl rounded-md p-5' sx={{alignItems:'center', justifyContent: 'space-between'}}>
                    ...
                    <Grid item xs={6}>
                        <div className='flex items-center'>
                            <img className='w-[5rem] h-[5rem] object-cover object-top' src={item.product.imageUrl} alt="product_phot" />

                        <div className="ml-5 space-y-2">
                        <p>{item.product.title}</p>
                        <div className="text-xs opacity-50 font-semibold space-x-5">
